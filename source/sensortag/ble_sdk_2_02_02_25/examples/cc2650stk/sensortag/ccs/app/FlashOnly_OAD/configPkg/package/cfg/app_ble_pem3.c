 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = D:/SSNS/source/sensortag/ble_sdk_2_02_02_25/examples/cc2650stk/sensortag/ccs/app/FlashOnly_OAD/configPkg/package/cfg/app_ble_pem3");
